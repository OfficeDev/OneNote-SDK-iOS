...
@implementation MSOneNoteApiPageCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSOneNoteApiPage class]];
}

- (void)add:(MSOneNoteApiPage*)entity callback:(void (^)(MSOneNoteApiPage *mSOneNoteApiPage, MSOrcError *error))callback {
...
- (MSOneNoteApiPageFetcher *)getById:(id) identifier {
    ...
    return [[MSOneNoteApiPageFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
