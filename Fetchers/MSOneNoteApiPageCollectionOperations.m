...
/** Implementation for MSOneNoteApiPageCollectionOperations
 *
 */
@implementation MSOneNoteApiPageCollectionOperations

- (void)patchContentWithCommands:(MSOneNoteApiPatchContentCommand *)commands callback:(void (^)(int, MSOrcError*))callback {
...
- (void)copyToSectionWithId:(NSString *)_id siteCollectionId:(NSString *)siteCollectionId siteId:(NSString *)siteId groupId:(NSString *)groupId callback:(void (^)(MSOneNoteApiCopyStatusModel *, MSOrcError*))callback {
