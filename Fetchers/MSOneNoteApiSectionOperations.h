...
#ifndef MSONENOTEAPISECTIONOPERATIONS_H
#define MSONENOTEAPISECTIONOPERATIONS_H
...
/** MSOneNoteApiSectionOperations
 *
 */
@interface MSOneNoteApiSectionOperations : MSOrcOperations
