...
@implementation MSOneNoteApiMyOrganizationCollectionFetcher

- (instancetype)initWithUrl:(NSString *)urlComponent parent:(id<MSOrcExecutable>)parent {

    return [super initWithUrl:urlComponent parent:parent asClass:[MSOneNoteApiMyOrganization class]];
}

- (void)add:(MSOneNoteApiMyOrganization*)entity callback:(void (^)(MSOneNoteApiMyOrganization *mSOneNoteApiMyOrganization, MSOrcError *error))callback {
...
- (MSOneNoteApiMyOrganizationFetcher *)getById:(id) identifier {
    ...
    return [[MSOneNoteApiMyOrganizationFetcher alloc] initWithUrl:[[NSString alloc] initWithFormat:@"('%@')" , identifier] parent:self];
}
