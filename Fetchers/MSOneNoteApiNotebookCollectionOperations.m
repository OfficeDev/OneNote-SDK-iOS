...
/** Implementation for MSOneNoteApiNotebookCollectionOperations
 *
 */
@implementation MSOneNoteApiNotebookCollectionOperations
...
- (void)exportNotebookRawWithCallback:(void (^)(NSString *, MSOrcError*))callback {
    ...
    [request setVerb:HTTP_VERB_POST];
	 	[request.url appendPathComponent:@"Microsoft.OneNote.Api.ExportNotebook"];
