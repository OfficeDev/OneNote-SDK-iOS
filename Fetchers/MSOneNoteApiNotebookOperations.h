...
#ifndef MSONENOTEAPINOTEBOOKOPERATIONS_H
#define MSONENOTEAPINOTEBOOKOPERATIONS_H
...
/** MSOneNoteApiNotebookOperations
 *
 */
@interface MSOneNoteApiNotebookOperations : MSOrcOperations
