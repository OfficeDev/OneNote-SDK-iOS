...
/** Implementation for MSOneNoteApiIdentitySet
 *
 */
@implementation MSOneNoteApiIdentitySet
...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
        if(dic!=nil) {
		_user = (![dic objectForKey: @"user"] || [ [dic objectForKey: @"user"] isKindOfClass:[NSNull class]] )?_user:[[MSOneNoteApiIdentity alloc] initWithDictionary: [dic objectForKey: @"user"]];
    }
 ...
 *
 */
- (void) setUser: (MSOneNoteApiIdentity *) value {
    _user = value;
