...
/** Implementation for MSOneNoteApiPage
 *
 */
...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
		...
		_links = (![dic objectForKey: @"links"] || [ [dic objectForKey: @"links"] isKindOfClass:[NSNull class]] )?_links:[[MSOneNoteApiPageLinks alloc] initWithDictionary: [dic objectForKey: @"links"]];
		...
		_parentSection = (![dic objectForKey: @"parentSection"] || [ [dic objectForKey: @"parentSection"] isKindOfClass:[NSNull class]] )?_parentSection:[[MSOneNoteApiSection alloc] initWithDictionary: [dic objectForKey: @"parentSection"]];
 ...
 *
 */
- (void) setLinks: (MSOneNoteApiPageLinks *) value {
    _links = value;
 ...
 *
 */
- (void) setParentSection: (MSOneNoteApiSection *) value {
