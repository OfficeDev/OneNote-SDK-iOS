...
/** Implementation for MSOneNoteApiOperation
 *
 */
@implementation MSOneNoteApiOperation
...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
		...
		_error = (![dic objectForKey: @"error"] || [ [dic objectForKey: @"error"] isKindOfClass:[NSNull class]] )?_error:[[MSOneNoteApiOperationError alloc] initWithDictionary: [dic objectForKey: @"error"]];
    }
 ...
 *
 */
- (void) setError: (MSOneNoteApiOperationError *) value {
    _error = value;
