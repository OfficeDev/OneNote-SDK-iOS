...
/** Implementation for MSOneNoteApiNotes
 *
 */
    ...
    if((self = [self init])) {
        ...
        if([dic objectForKey: @"notebooks"] != [NSNull null]){
            ...
            for (id object in [dic objectForKey: @"notebooks"]) {
                [_notebooks addObject:[[MSOneNoteApiNotebook alloc] initWithDictionary: object]];
            }
        ...
        if([dic objectForKey: @"resources"] != [NSNull null]){
            ...
            for (id object in [dic objectForKey: @"resources"]) {
                [_resources addObject:[[MSOneNoteApiResource alloc] initWithDictionary: object]];
            }
        ...
        if([dic objectForKey: @"operations"] != [NSNull null]){
            ...
            for (id object in [dic objectForKey: @"operations"]) {
                [__operations addObject:[[MSOneNoteApiOperation alloc] initWithDictionary: object]];
            }
