...
#ifndef MSONENOTEAPIIMPORTSTATUSMODEL_H
#define MSONENOTEAPIIMPORTSTATUSMODEL_H
...
/** Interface MSOneNoteApiImportStatusModel
 *
 */
@interface MSOneNoteApiImportStatusModel : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
