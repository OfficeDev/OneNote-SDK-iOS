...
/** Implementation for MSOneNoteApiMyOrganization
 *
 */
@implementation MSOneNoteApiMyOrganization
    ...
    if((self = [self init])) {
        ...
        if([dic objectForKey: @"siteCollections"] != [NSNull null]){
            ...
            for (id object in [dic objectForKey: @"siteCollections"]) {
                [_siteCollections addObject:[[MSOneNoteApiSiteCollection alloc] initWithDictionary: object]];
            }
        ...
        if([dic objectForKey: @"groups"] != [NSNull null]){
            ...
            for (id object in [dic objectForKey: @"groups"]) {
                [_groups addObject:[[MSOneNoteApiGroup alloc] initWithDictionary: object]];
            }
