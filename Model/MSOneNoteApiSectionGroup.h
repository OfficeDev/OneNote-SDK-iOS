...
#ifndef MSONENOTEAPISECTIONGROUP_H
#define MSONENOTEAPISECTIONGROUP_H
...
/** Interface MSOneNoteApiSectionGroup
 *
 */
@interface MSOneNoteApiSectionGroup : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
 ...
 *
 */
@property (nonatomic,  copy, setter=setParentSectionGroup:, getter=parentSectionGroup) MSOneNoteApiSectionGroup * parentSectionGroup;
