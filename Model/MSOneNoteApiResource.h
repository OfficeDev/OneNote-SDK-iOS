...
#ifndef MSONENOTEAPIRESOURCE_H
#define MSONENOTEAPIRESOURCE_H
...
/** Interface MSOneNoteApiResource
 *
 */
@interface MSOneNoteApiResource : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
