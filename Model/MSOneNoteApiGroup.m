...
/** Implementation for MSOneNoteApiGroup
 *
 */
@implementation MSOneNoteApiGroup
...
- (instancetype) initWithDictionary: (NSDictionary *) dic {
    if((self = [self init])) {
		...
		_notes = (![dic objectForKey: @"notes"] || [ [dic objectForKey: @"notes"] isKindOfClass:[NSNull class]] )?_notes:[[MSOneNoteApiNotes alloc] initWithDictionary: [dic objectForKey: @"notes"]];
    }
 ...
 *
 */
- (void) setNotes: (MSOneNoteApiNotes *) value {
    _notes = value;
