...
#ifndef MSONENOTEAPIPAGE_H
#define MSONENOTEAPIPAGE_H
...
/** Interface MSOneNoteApiPage
 *
 */
@interface MSOneNoteApiPage : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
 ...
 *
 */
@property (nonatomic,  copy, setter=setLinks:, getter=links) MSOneNoteApiPageLinks * links;
 ...
 *
 */
@property (nonatomic,  copy, setter=setParentSection:, getter=parentSection) MSOneNoteApiSection * parentSection;

/** Property parentNotebook
 *
 */
@property (nonatomic,  copy, setter=setParentNotebook:, getter=parentNotebook) MSOneNoteApiNotebook * parentNotebook;
