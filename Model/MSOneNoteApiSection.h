...
#ifndef MSONENOTEAPISECTION_H
#define MSONENOTEAPISECTION_H
...
/** Interface MSOneNoteApiSection
 *
 */
@interface MSOneNoteApiSection : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
