...
#ifndef MSONENOTEAPICOPYSTATUSMODEL_H
#define MSONENOTEAPICOPYSTATUSMODEL_H
...
/** Interface MSOneNoteApiCopyStatusModel
 *
 */
@interface MSOneNoteApiCopyStatusModel : MSOrcBaseEntity <MSOrcInteroperableWithDictionary>
